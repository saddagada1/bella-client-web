    ...
    <>
      {!username && !googleAuthCode ? (
        <>
          ...
          <div className="w-full pt-4 border-t border-solid border-secondary">
            <button
  ...
  return (
    <div className="w-screen h-screen z-50 fixed flex justify-center items-center">
      ...
      <div className="w-11/12 sm:w-10/12 p-6 z-10 bg-primary flex flex-col items-center rounded-xl">
        <h1 className="w-full text-center text-2xl pb-4 border-b border-solid border-secondary font-display font-black uppercase">
          Welcome!
        </h1>
        {view === "login" ? (
          loginWithEmail ? (
